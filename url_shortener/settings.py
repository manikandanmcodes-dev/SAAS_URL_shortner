...
SECRET_KEY = 'django-insecure-vyet3u&rqc%eyulj)_cw(*grll*xt%j)pg@5!(q6d$9!n3fnxe'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['saas-url-shortner-backend.onrender.com']
...
CORS_ALLOW_ALL_ORIGINS = [
    "https://saas-url-shortner.vercel.app/",
]
